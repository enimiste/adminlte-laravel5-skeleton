...
namespace Dowilcox\KnpMenu\Facades {
    ...
    class Menu {
        ...
        {
            return \Dowilcox\KnpMenu\Menu::create($name, $options);
        }
        ...
        {
            return \Dowilcox\KnpMenu\Menu::get($name);
        }
        ...
        {
            return \Dowilcox\KnpMenu\Menu::forget($name);
        }
        
        /**
         * Render passed menu.
         *
         * @param \Dowilcox\KnpMenu\ItemInterface $menu
         * @param array $options
         * @return mixed 
         * @static 
         */
        public static function render($menu, $options = array())
        {
            return \Dowilcox\KnpMenu\Menu::render($menu, $options);
        }
        
        /**
         * Get the factory instance.
         *
         * @return \Dowilcox\KnpMenu\MenuFactory 
         * @static 
         */
        public static function getFactory()
        {
            return \Dowilcox\KnpMenu\Menu::getFactory();
        }
        
        /**
         * Get the matcher instance.
         *
         * @return \Dowilcox\KnpMenu\MatcherInterface 
         * @static 
         */
        public static function getMatcher()
        {
            return \Dowilcox\KnpMenu\Menu::getMatcher();
        }
        
        /**
         * Get the renderer instance.
         *
         * @return \Dowilcox\KnpMenu\RendererInterface 
         * @static 
         */
        public static function getRenderer()
        {
            return \Dowilcox\KnpMenu\Menu::getRenderer();
        }
        
        /**
         * 
         *
         * @param \Dowilcox\KnpMenu\MatcherInterface $matcher
         * @return \Menu 
         * @static 
         */
        public static function setMatcher($matcher)
        {
            return \Dowilcox\KnpMenu\Menu::setMatcher($matcher);
        }
        
        /**
         * 
         *
         * @param \Dowilcox\KnpMenu\RendererInterface $renderer
         * @return \Menu 
         * @static 
         */
        public static function setRenderer($renderer)
        {
            return \Dowilcox\KnpMenu\Menu::setRenderer($renderer);
        }
...
namespace {
    ...
    class Menu extends \Dowilcox\KnpMenu\Facades\Menu {}
